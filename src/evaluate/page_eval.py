...
client = OpenAI(api_key="sk-055933b147d84d78893e09e2b432c79a", base_url="https://api.deepseek.com")

# DEEPSEEK_API_KEY = 'sk-055933b147d84d78893e09e2b432c79a'
# API_URL = 'https://api.deepseek.com'

def translate_with_deepseek(text, target_language="en"):
...
def extract_text(block: dict) -> str:
    ...
    if text is None or text.strip() == '':
        return ''
    return translate_with_deepseek(text, target_language="en")
...
def main():
    ...
    if args.output_path is None:
        args.output_path = os.path.join(os.path.dirname(args.generated_pptx), "ref_eval.json")
        json.dump(final_results, open(args.output_path, 'w'))
